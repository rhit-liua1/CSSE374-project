...
public class Order implements Observer{
    ...
    private CoffeeMachineController2 cm;
    private ControllerResponse cr;
    private String[] condiments;

    public Order(int orderId, String drink, Address address, CoffeeMachineController2 cm, String[] condiments) {
    ...
    @Override
    public void update(CoffeeMachineController2 cm) {
        this.cm = cm;
        generateCR();
    }
